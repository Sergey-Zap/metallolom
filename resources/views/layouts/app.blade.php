...
<head>
    ...
    <title>{{ config('app.name', 'Металлолом Запорожье') }}</title>
    ...
    <link href="{{asset('admin-panel/sb-admin-2.min.css')}}" rel="stylesheet" type="text/css">
        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Металлолом Запорожье') }}
                </a>
