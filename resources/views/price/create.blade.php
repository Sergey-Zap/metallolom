...
@section('contents')
    ...
    <form method="post" action="store">
        ...
        <input type="text" name="name" placeholder="Название" required class="mt-3 form-categories card border-left-primary shadow py-2 px-2">
        <label class="mt-4 form-label lead">Цена</label>
        <input type="number" name="cost" placeholder="0.0" required step="0.01" min="0" max="1000000" class="mt-3 form-categories lead card border-left-primary shadow py-2 px-2">
